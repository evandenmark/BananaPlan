    ...
    <div className="p-4">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          ...
          className="bg-green-700 text-white px-5 py-3 rounded-xl text-base font-semibold active:scale-95 transition-transform"
        >
          + Plant
        </Link>
      </div>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-1 ml-3 shrink-0">
                    <Link
                      ...
                      className="text-base text-green-700 font-semibold px-3 py-2 active:opacity-60 transition-opacity"
                    >
                      Edit
                    </Link>
                    <form
                    ...
                    >
                      <button
                        type="submit"
                        className="text-base text-red-600 font-semibold px-3 py-2 active:opacity-60 transition-opacity"
                      >
                        Remove
                      </button>
                    </form>
